...
expect(count("rounded-xl border bg-card p-4")).toBe(1);
...
it("preserves the My CVs data and navigation behavior", () => {
...
expect(count('to="/dashboard/cvmate/create"')).toBe(1);
