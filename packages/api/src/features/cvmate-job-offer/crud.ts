...
export const crudRouter = {
	...
	getById: protectedProcedure
		.route({
			...
			successDescription: "The CVMate job offer.",
		})
	...
	create: protectedProcedure
		.route({
			...
			summary: "Create CVMate job offer",
			description:
			...
			successDescription: "The ID of the newly created CVMate job offer.",
		})
	...
	update: protectedProcedure
		.route({
			...
			summary: "Update CVMate job offer",
			description:
			...
			successDescription: "The updated CVMate job offer.",
		})
	...
	delete: protectedProcedure
		.route({
			...
			summary: "Delete CVMate job offer",
			description:
			...
			successDescription: "The CVMate job offer was deleted successfully.",
		})
	...
	uploadAsset: protectedProcedure
		.route({
			...
			summary: "Upload CVMate job-offer asset",
			description:
	...
	updateAsset: protectedProcedure
		.route({
			...
			summary: "Update CVMate job-offer asset",
			description:
	...
	deleteAsset: protectedProcedure
		.route({
			...
			summary: "Delete CVMate job-offer asset",
			description:
	...
	createRequirement: protectedProcedure
		.route({
			...
			summary: "Create CVMate job requirement",
			description:
	...
	updateRequirement: protectedProcedure
		.route({
			...
			summary: "Update CVMate job requirement",
			description:
	...
	deleteRequirement: protectedProcedure
		.route({
			...
			summary: "Delete CVMate job requirement",
			description:
